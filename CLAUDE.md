...
- `cleaner_app`'s new completion-checkmark animation (from the 2026-08-27 depth/font/illustration pass) still hasn't had its own device pass — see the note under Known stubs above.
