...
/// weak password), not just display it — so this carries the backend's
/// machine-readable `code` and any per-field validation errors alongside
/// the human message.
...
class HttpAuthRepository implements AuthRepository {
  ...
  /// Fixed per app instance — 'cleaner' here, never user-supplied.
  final String role;
