...
/// The booking thread.
///
/// Private to you and your cleaner, and only while the booking is live: the
      ...
      return Center(
        child: Padding(
          ...
          child: Column(mainAxisSize: MainAxisSize.min, children: [
            ...
            const SizedBox(height: Sparkle.s3),
            Text(
              _closed ? 'This conversation has closed.' : 'Message your cleaner about access, parking, or timing.',
            ...
            if (!_closed) ...[
              ...
              const Text('Private to this booking. Closes 24 hours after the job.',
                  textAlign: TextAlign.center, style: TextStyle(fontSize: 12, color: Sparkle.inkSoft)),
            ],
          ]),
        ),
      );
        ...
        child: Row(
          ...
          children: [
            ...
            IconButton(
              ...
              icon: _sending
                  ? const SizedBox(height: 20, width: 20, child: CircularProgressIndicator(strokeWidth: 2, color: Sparkle.seafoam))
                  : const Icon(Icons.send_rounded, color: Sparkle.seafoam),
            ),
          ],
        ),
      ),
    ...
    return Align(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: mine ? Sparkle.seafoam : Sparkle.surface,
        ...
        child: Column(
          ...
          children: [
            ...
            Text(time, style: TextStyle(fontSize: 10, color: mine ? Colors.white70 : Sparkle.inkSoft)),
          ],
        ),
      ),
    );
